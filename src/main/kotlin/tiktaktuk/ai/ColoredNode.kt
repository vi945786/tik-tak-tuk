...
class ColoredNode(val winningColor: Color) {
    ...
    val DROP_OFF_VALUE: Double = 0.95
    val TERMINAL_DROP_OFF_VALUE: Double = 0.95

    val WIN_VALUE: Double = 10.0
    val LOSE_VALUE: Double = -10.0
    val TIE_VALUE: Double = -0.0

    val BEST_MOVE_WEIGHT: Double = 0.125
